...
namespace hyp_vlk
{
	namespace hyp_backend {
		...
		void DeviceSystem::CreateLogicalDevice(VkPhysicalDevice &physicalDevice, VkDevice &device, VkQueue& graphicsQueue, VkQueue& presentQueue, std::vector<const char*> &deviceExtensions)
		{
