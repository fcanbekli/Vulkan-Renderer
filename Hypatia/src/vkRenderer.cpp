...
namespace hyp_backend {
	...
	uint32_t RendererBackend::FindMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
	{
	...
	void RendererBackend::CreateBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
	{
